...
namespace LibrarySystem.Web
{
    ...
    public class LibrarySystemTable : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            {
                output.Content.AppendHtml($"<th style='cursor:pointer' onclick=\"window.location = '/?Page={Page}&PageSize={pageSize}&OrderByProperty={column}&IsAscending={(column == orderBy && isAscending ? false : true)}'\">{column} {(orderBy == column ? "<i class=\"bi bi-sort-" + (isAscending ? "up" : "down") + "\"></i>" : "")}</th>");
            }
            ...
            string pagination = "<div class=\"SysCorePaginationDiv\"><p class=\"SysCorePaginationStatus\"><small>" + ((pageSize * page) - (pageSize - 1)) + "-" + (pageSize * page) + " of 20</small></p>  <ul class=\"pagination SysCorePagination\">\r\n    <li class=\"page-item " + (page == 1 ? " disabled" : "") + "\">\r\n      <a class=\"page-link\" href=\"/?Page=" + (page - 1) + "&PageSize=" + pageSize + "&OrderByProperty=" + orderBy + "&IsAscending=" + isAscending + "\">&laquo;</a>\r\n    </li>";

            for (int i = 1; i <= numberOfPage; i++)
            {
                pagination += "<li class=\"page-item " + (i == page ? "active" : "") + " \">\r\n      <a class=\"page-link\" href=\"/?Page=" + i + "&PageSize=" + pageSize + "&OrderByProperty=" + orderBy + "&IsAscending=" + isAscending + "\">" + i + "</a>\r\n    </li>";
            }

            pagination += "<li class=\"page-item " + (page == numberOfPage ? " disabled" : "") + "\">\r\n      <a class=\"page-link\" href=\"/?Page=" + (page + 1) + "&PageSize=" + pageSize + "&OrderByProperty=" + orderBy + "&IsAscending=" + isAscending + "\">&raquo;</a>\r\n    </li>\r\n  </ul>\r\n</div>";
            ...
            output.PreElement.AppendHtml("const " + Id + "JsTable = new MyTable('" + Id + "');");
